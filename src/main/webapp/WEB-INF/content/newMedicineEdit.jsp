                                            ...
                                            <div class="form-group col-xs-12 col-sm-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control" id="devpStage"
                                                        ...
                                                        <option value="">临床前研究</option>
                                                        <option value="">临床研究</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    var entity = ${ObjectMapper.writeValueAsString(newMedicine)};
    var all = ${ObjectMapper.writeValueAsString(newMedicine.argMap)};
