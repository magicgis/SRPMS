                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <form id="appraise" class="form-horizontal" role="form">
                                                    ...
                                                    <div class="form-group col-xs-12 col-sm-6">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input id="certificateNo" name="certificateNo"
                                                                   type="text" class="form-control col-xs-12"
                                                                   placeholder="" value="${certifyUnit.certificateNo}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6 widget-container-col ui-sortable"
                                 id="fileHead">
                                <div class="widget-box transparent ui-sortable-handle" style="opacity: 1;">
                                    <div class="widget-header">
...
//    console.log(order);
    ...
    DisplayForm($('#appType').selectize(), order['appType'], 0);
    //    addOptionSelectize($('#appRank').selectize(), [standardId]);
//    DisplayForm($('#appRank').selectize(), standard['id'], 0);
...
<%--<script src="<c:url value="/js/teac/appraiseEdit.js"/>"></script>--%>
<%--</c:when>--%>
