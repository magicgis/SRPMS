  ...
  <div class="main-content">
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="row">
          <div class="col-xs-12">
            <div class="widget-box transparent " style="opacity: 1;" id="medicineTable-box">
              <div class="widget-body" id="publicArea">
                <table id="NewMedicineTable"
                       data-toolbar="#tNewMedicineToolbar"
                       data-search="true"
                ...
                <div id="tNewMedicineToolbar">
                  <button id="addNewMedicine" class="btn btn-primary">
          ...
          <div class="col-xs-12">
            <div class="widget-box transparent ui-sortable-handle collapsed" style="opacity: 1;"
              ...
              <div class="widget-body">
                <div class="row">
                  <jsp:include page="public/newMedicineForm.jsp"/>
...
<!-- /.main-container -->
<script src='../public/js/pubNewMedicine.js'></script>
<script src="../public/js/public.js"></script>
<script src="js/newMedicine.js"></script>
<script type="text/javascript">
  jQuery(function ($) {
