  ...
  <div class="main-content">
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="row">
          <div class="col-xs-12">
            <div class="widget-box transparent " style="opacity: 1;" id="differentTable-box">
              <div class="widget-body">
                <table id="differentTable"
                       data-toolbar="#tdifferentToolbar"
                       data-search="true"
          ...
          <div class="col-xs-12">
            <div class="widget-box transparent ui-sortable-handle collapsed" style="opacity: 1;"
              ...
              <div class="widget-body">
                <div class="row" >
                  <div id="differentChange">
                    <%--<jsp:include page="../public/differentPaperForm.jsp"/>--%>
                  </div>
...
<script src='../public/js/pubDifferent.js'></script>
<script src="js/different.js"></script>
<script type="text/javascript">
  jQuery(function ($) {
