            ...
            <div class="page-content">
                <div class="row">
                    <form id="award" class="form-horizontal" role="form">
                        <div hidden="hidden">
                            <input type="text" name="id" id="newFoodId" value="${newFoodId.id}"/>
                        </div>
                                ...
                                <div class="widget-body ">
                                    <div class="widget-main">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xs-12 col-sm-6">
                                                <label class="col-sm-4 control-label no-padding-left"
                                                       for="newFoodDate">获批时间</label>

                                                <div class="col-sm-8">
                                                    <input class="form-control date-picker" id="newFoodDate"
                                                           type="text" name="newFoodDate"
