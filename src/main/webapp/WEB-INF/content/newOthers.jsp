  ...
  <div class="main-content">
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="row">
          <div class="col-xs-12">
            <div class="widget-box transparent " style="opacity: 1;" id="newOtherTable-box">
              <div class="widget-body" id="publicArea">
                <table id="NewOtherTable"
                       data-toolbar="#tNewOtherToolbar"
                       data-search="true"
                ...
                <div id="tNewOtherToolbar">
                  <button id="addNewOther" class="btn btn-primary">
                    <i class="fa fa-plus"></i> 添加新产品
                  </button>
          ...
          <div class="col-xs-12">
            <div class="widget-box transparent ui-sortable-handle collapsed" style="opacity: 1;"
              ...
              <div class="widget-body">
                <div class="row">
                  <jsp:include page="public/newOthersForm.jsp"/>
...
<!-- /.main-container -->
<script src='../public/js/pubNewOther.js'></script>
<script src="../public/js/public.js"></script>
<script src="js/newOther.js"></script>
<script type="text/javascript">
  jQuery(function ($) {
