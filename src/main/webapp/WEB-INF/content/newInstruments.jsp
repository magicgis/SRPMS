  ...
  <div class="main-content">
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="row">
          <div class="col-xs-12">
            <div class="widget-box transparent " style="opacity: 1;" id="instrumentsTable-box">
              <div class="widget-body" id="publicArea">
                <table id="NewInstrumentsTable"
                       data-toolbar="#tInstrumentsToolbar"
                       data-search="true"
                ...
                <div id="tInstrumentsToolbar">
                  <button id="addInstruments" class="btn btn-primary">
                    <i class="fa fa-plus"></i> 添加医疗器械
                  </button>
          ...
          <div class="col-xs-12">
            <div class="widget-box transparent ui-sortable-handle collapsed" style="opacity: 1;"
              ...
              <div class="widget-body">
                <div class="row">
                  <jsp:include page="public/newInstrumentsForm.jsp"/>
...
<!-- /.main-container -->
<script src='../public/js/pubInstruments.js'></script>
<script src="../public/js/public.js"></script>
<script src="js/newInstruments.js"></script>
<script type="text/javascript">
  jQuery(function ($) {
