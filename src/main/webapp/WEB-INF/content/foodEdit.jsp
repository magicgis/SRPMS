				...
				<div class="row">
					<form id="food" class="form-horizontal" role="form">
						<div hidden="hidden">
							...
							<input type="text" name="WF_Type" id="WF_Type" value="food"/>
						</div>
						<div class="col-xs-12 col-md-6">

							<div id="foodInfo" class="col-xs-12 widget-container-col ui-sortable">
											...
											<div class="row">
												...
												<div class="col-sm-8">
													<input type="text" id="productNo" name="productNo"
													       ...
													       placeholder="" value="${food.productNo}"/>
												</div>
											</div>
											<div class="row">
												<div class="form-group col-xs-12 col-sm-6">
													...
													<div class="col-sm-8">
														<input class="form-control date-picker" id="date"
														       type="text" name="date"
														       data-date-format="yyyy-mm-dd" value="${food.date}" />
													</div>
												</div>
											...
											<div class="row">
                                                ...
                                                <span class="giveSum">
                                                    ...
                                                    <input class="score" type="text"
                                                           name="score" id="totalScore" value="${food.score}"
...
<script type="text/javascript">
	...
	var entity =  ${ObjectMapper.writeValueAsString(food)}; // 获得 order 或 实体
