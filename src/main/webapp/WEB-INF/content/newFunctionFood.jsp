  ...
  <div class="main-content">
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="row">
          <div class="col-xs-12">
            <div class="widget-box transparent " style="opacity: 1;" id="foodTable-box">
              <div class="widget-body" id="publicArea">
                <table id="NewFoodTable"
                       data-toolbar="#NewFoodToolbar"
                       data-search="true"
                ...
                <div id="NewFoodToolbar">
                  <button id="addNewFood" class="btn btn-primary">
                    <i class="fa fa-plus"></i> 添加新药
                  </button>
          ...
          <div class="col-xs-12">
            <div class="widget-box transparent ui-sortable-handle collapsed" style="opacity: 1;"
              ...
              <div class="widget-body">
                <div class="row">
                  <jsp:include page="public/newFoodForm.jsp"/>
...
<!-- /.main-container -->
<script src='../public/js/pubFood.js'></script>
<script src="js/functionFood.js"></script>
<script type="text/javascript">
  jQuery(function ($) {
